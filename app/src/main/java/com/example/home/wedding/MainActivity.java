...
public class MainActivity extends AppCompatActivity {
        ...
        switch (requestCode)
        {
            case PERMISSION_REQUEST_CODE:
                if (grantResults.length > 0) {
                    ...
                    if (intern && writed && callphone && readphonestate) {
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(this, new String[]{INTERNET,WRITE_EXTERNAL_STORAGE,READ_PHONE_STATE,CALL_PHONE}, PERMISSION_REQUEST_CODE);
    }
}
